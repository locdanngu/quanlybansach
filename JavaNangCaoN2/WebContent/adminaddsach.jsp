...
<body>
    <div class="header">
   	...
   	<div style="margin-top: 100px;text-align: center;">
   		<form action="addsach" method="post">
   			<p style="font-size: 30px;font-weight: bolder;">Nhập thông tin sách</p>
	   		<div style="margin-top: 10px;margin-bottom: 3px;">
		        <input style="" class="input-box" type="text" name="ms" value="" required="required" placeholder="Nhập mã sách">
		    </div>
	   		<div style="margin-top: 10px;margin-bottom: 3px;">
		        <input style="" class="input-box" type="text" name="ts" value="" required="required" placeholder="Nhập tên sách">
		    </div>
		    <div style="margin-top: 10px;margin-bottom: 3px;">
		        <input style="" class="input-box" type="text" name="sl" value="" required="required" placeholder="Nhập số lượng">
		    </div>
		    <div style="margin-top: 10px;margin-bottom: 3px;">
		        <input style="" class="input-box" type="text" name="g" value="" required="required" placeholder="Nhập giá">
		    </div>
		    <div style="margin-top: 10px;margin-bottom: 3px;">
		        <select name="ml" style="height: 40px;width: 300px;border-radius: 10px;text-align: center; ">
		             <%
		    ...
		    <div style="margin-top: 10px;margin-bottom: 3px;">
		        <input style="" class="input-box" type="text" name="st" value="" required="required" placeholder="Nhập số tập">
		    </div>
		    <div style="margin-top: 10px;margin-bottom: 3px;">
		    	<input style="" class="input-box" type="file" name="anh" value="" id="">
		    </div>
		    <div style="margin-top: 10px;margin-bottom: 3px;">
		        <input style="" class="input-box" type="date" name="nn" value="" required="required" placeholder="Nhập ngày">
		    </div>
		    <div style="margin-top: 10px;margin-bottom: 3px;">
		        <input style="" class="input-box" type="text" name="tg" value="" required="required" placeholder="Nhập tác giả">
		    </div>
