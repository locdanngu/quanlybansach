...
<head>
    ...
    <title>Sửa thông tin loại</title>
...
<body>
    ...
    <div style="display: flex;justify-content: center;margin-top: 110px;">
	   	<div style="margin-top: 0px;text-align: center;margin-right: 250px;">
	   		<p style="font-size: 30px;font-weight: bolder;">Thông tin loại sách cũ</p>
	   		<p>Mã loại sách: <%=session.getAttribute("ml") %></p>
	   		<p>Tên loại sách: <%=session.getAttribute("tl") %></p>
	   		
	   	</div>
	   	<div style="margin-top: 0px;text-align: center;">
	   		<form action="fixloai?ml=<%=session.getAttribute("ml")%>" method="post">
	   			<p style="font-size: 30px;font-weight: bolder;">Nhập thông tin loại sách mới</p>
		   		<div style="margin-top: 10px;margin-bottom: 3px;">
			        <input style="" class="input-box" type="text" name="mlm" value="" required="required" placeholder="Nhập mã loại sách">
			    </div>
		   		<div style="margin-top: 10px;margin-bottom: 3px;">
			        <input style="" class="input-box" type="text" name="tlm" value="" required="required" placeholder="Nhập tên loại sách">
			    </div>
