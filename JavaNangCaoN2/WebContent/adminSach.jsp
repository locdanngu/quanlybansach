    ...
    <div class="header">
   	...
   	<div>
   		<div style="margin-top: 90px;margin-bottom: 15px;">
   			<form class="" action="adminSachController" method="get">
			    <input style="padding-left: 10px;height: 35px;margin-left: 535px;width: 300px;border-radius: 5px;" name="gttk" class="" type="text" placeholder="Nhập thông tin sách bạn muốn tìm" aria-label="Search">
   		...
   		<a style="margin-top: 120px;margin-left: 660px;" href="addsachcontroller">Thêm Sách</a>
   		<table style="margin-top: 15px;width: -webkit-fill-available;text-align: center;">
			...
			%>
   			...
   			<tr>
   				<td><%=s.getMasach() %></td>
   				<td><img style="width: 125px;" src="<%=s.getAnh() %>"></td>
   				<td><%=s.getTensach() %></td>
   				<td><%=s.getSotap() %></td>
   				<td><%=s.getTacgia() %></td>
   				<td><%=s.getMaloai() %></td>
   				...
   				<td><%=s.getNgaynhap() %></td>
   				<td style="">
   					<div style="display: -webkit-inline-box; margin-top: 7px;">
   						<form class="" action="suasachcontroller" method="post">
   							<button class="nut" style="background-color:  #f5f5f5;border:0px;">Sửa</button>
   							<input class="input-box9" name ="ms" placeholder="Mã sách" value="<%=s.getMasach()%>">
   							<input class="input-box9" name ="ts" placeholder="Mã sách" value="<%=s.getTensach()%>">
   							<input class="input-box9" name ="sl" placeholder="Mã sách" value="<%=s.getSoluong()%>">
   							<input class="input-box9" name ="g" placeholder="Mã sách" value="<%=s.getGia()%>">
   							<input class="input-box9" name ="ml" placeholder="Mã sách" value="<%=s.getMaloai()%>">
   							<input class="input-box9" name ="st" placeholder="Mã sách" value="<%=s.getSotap()%>">
   							<input class="input-box9" name ="anh" placeholder="Mã sách" value="<%=s.getAnh()%>">
   							<input class="input-box9" name ="nn" placeholder="Mã sách" value="<%=s.getNgaynhap()%>">
   							<input class="input-box9" name ="tg" placeholder="Mã sách" value="<%=s.getTacgia()%>">
   							
   						</form>
	   					<p> | </p>
	   					<a style="" href="xoasachcontroller?ms=<%=s.getMasach()%>">Xóa</a>
   					</div>
