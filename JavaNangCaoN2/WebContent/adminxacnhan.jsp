    ...
    <div class="header">
        <div class="header_ctn">
			...
			%>
                ...
                <li><a class="list_nav active" href="listdoncontroller">Xác nhận hoá đơn</a></li>
            ...
            %>  
                ...
                <li><a class="list_nav active" href="ktdnAdminController">Xác nhận hoá đơn</a></li>
   	...
   	<table style="margin-top: 90px;width: -webkit-fill-available;text-align: center;">
			...
			if(request.getAttribute("dsdon")!=null){
				ArrayList<xacnhanbean> dsdon = (ArrayList<xacnhanbean>) request.getAttribute("dsdon");
				for(xacnhanbean d: dsdon){
			%>
			
   			<tr>
   				<td><%=d.getMaHoaDon() %></td>
   				<td><%=d.getMaChiTietHD() %></td>
   				<td><%=d.getMakh() %></td>
   				<td><%=d.getHoten() %></td>
   				<td><%=d.getTensach() %></td>
   				
   				<td><%=d.getNgayMua() %></td>
   				<td><%=d.getSoLuongMua() %></td>
   				<td><%=d.getGia() %></td>
   				<td><%=d.getThanhTien()%></td>
   				<td>Chưa xác nhận</td>
   				<td><a href="xacnhanhoadon?mcthd=<%=d.getMaChiTietHD()%>">Xác nhận giao</a></td>
   			</tr>
   			<%}} %>
