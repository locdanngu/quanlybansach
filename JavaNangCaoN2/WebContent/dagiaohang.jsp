...
<body>
    <div class="header">
        <div class="header_ctn">
			...
			%>
                ...
                <li><a class="list_nav" href="listdoncontroller">Xác nhận hoá đơn</a></li>
                 <li><a class="list_nav active" href="listdondaduyetcontroller">Đơn đã duyệt</a></li>
            <%
				}else{
            %>  
                ...
                <li><a class="list_nav" href="ktdnAdminController">Xác nhận hoá đơn</a></li>
                 <li><a class="list_nav active" href="ktdnAdminController">Đơn đã duyệt</a></li>
			<%} %>
			<%
				if(session.getAttribute("DangNhapAD")==null){
			%>
   	...
   	<table style="margin-top: 90px;width: -webkit-fill-available;text-align: center;">
			...
			if(request.getAttribute("dsdagiao")!=null){
				ArrayList<dagiaobean> dsdagiao = (ArrayList<dagiaobean>) request.getAttribute("dsdagiao");
				for(dagiaobean dg: dsdagiao){
			%>
			
   			<tr>
   				<td><%=dg.getMaHoaDon() %></td>
   				<td><%=dg.getMaChiTietHD() %></td>
   				<td><%=dg.getMakh() %></td>
   				<td><%=dg.getHoten() %></td>
   				<td><%=dg.getTensach() %></td>
   				
   				<td><%=dg.getNgayMua() %></td>
   				<td><%=dg.getSoLuongMua() %></td>
   				<td><%=dg.getGia() %></td>
   				<td><%=dg.getThanhTien()%></td>
   				<td>Đã duyệt</td>
